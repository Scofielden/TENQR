...
d = ['save H:\Matlab7\CAViaRCodes\Results\TABLE', int2str(THETA(1)), ' TABLE', int2str(THETA(1)), ' -ascii -double'];
e = ['save H:\Matlab7\CAViaRCodes\Results\TABLE', int2str(THETA(2)), ' TABLE', int2str(THETA(2)), ' -ascii -double'];
eval(d), eval(e)
...
% Save the workspace.
save H:\Matlab7\CAViaRCodes\Results\allmodels01_07_50
toc